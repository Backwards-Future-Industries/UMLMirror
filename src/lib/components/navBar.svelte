...
<div
  ...
  <div
    class="bg-green-800 pl-10 pr-10 pt-5 pb-5 -mr-5 rounded-tr-[25px] rounded-br-[25px] text-white flex items-center justify-center font-mono text-2xl">
    <a href="/graphical">Graphical</a>
  </div>
  <div
    class="bg-green-900 pl-10 pr-10 pt-5 pb-5 -mr-5 rounded-tr-[25px] rounded-br-[25px] text-white flex items-center justify-center font-mono text-2xl">
    <a href="/">UMLPlanter</a>
  </div> 
</div>